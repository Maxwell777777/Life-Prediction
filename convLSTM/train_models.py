...
class model:
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            if self._arq == 0:
                save_path = saver.save(sess, self._model_path + "Conv" + str(self._kind) + "/")
            else:
                save_path = saver.save(sess, self._model_path + "Conv" + str(self._kind) + "_ED/")
    ...
    def test(self):
        ...
        with tf.Session() as sess:
            sess.run(init)
            if self._arq == 0:
                saver.restore(sess, self._model_path + "Conv" + str(self._kind) + "/")
            else:
                saver.restore(sess, self._model_path + "Conv" + str(self._kind) + "_ED/")
